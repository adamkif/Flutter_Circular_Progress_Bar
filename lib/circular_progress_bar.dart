...
class ProgressBarPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    // rect is what the full oval would be inscribed within.
    // startAngle is the location on the oval that the line starts drawing from. An angle of 0 is at the right side. Angles are in radians, not degrees. The top is at 3π/2 (or -π/2), the left at π, and the bottom at π/2.
    // sweepAngle is how much of the oval is included in the arc. Again, angles are in radians. A value of 2π would draw the entire oval.
